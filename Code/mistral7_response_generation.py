...
# df = pd.read_pickle('/home/joshb/llm/output_data/result.pkl')
# df = pd.read_pickle('/home/joshb/llm/input_data/10000_question.pkl')
df = pd.read_pickle('/home/joshb/llm/sonaa/output/DS1.pkl')
...
for index, row in df.iterrows():
    ...
    df.at[index, 'mistral_text'] = generated_text
    df.at[index, 'mistral_time'] = end_time - start_time
...
df.to_csv('/home/joshb/llm/sonaa/metrics/DS2.csv')
